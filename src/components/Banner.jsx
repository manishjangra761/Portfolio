...
const stats = [
  ...
  { label: "Current", value: "Full Stack @ Qvolv" },
];
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-2 text-lg text-slate-300">
                ...
                <TypeAnimation
                  sequence={["with thoughtful UX", 1200, "with calm reliability", 1200, "with secure APIs", 1200]}
                  speed={48}
                  wrapper="span"
                  repeat={Infinity}
            ...
            <p className="text-lg text-slate-200 max-w-2xl leading-8">
              I pair crisp interfaces with dependable backends. Currently shipping a multi-tenant education platform at
              Qvolv Technologies; previously delivered ONDC features across agriculture, retail, mobility, and insurance at
              SequelString AI.
            </p>
            ...
            <div className="relative rounded-3xl border border-slate-800 bg-[#0f172a]/90 shadow-[0_24px_70px_rgba(0,0,0,0.45)] overflow-hidden">
              ...
              <div className="absolute inset-x-4 bottom-4 rounded-2xl border border-slate-700 bg-[#0f172a]/90 p-4 shadow-sm">
                <div className="flex items-center justify-between text-sm text-slate-200">
                  <span>Currently</span>
                  <span className="font-semibold text-white">Qvolv Technologies</span>
                </div>
                <p className="text-xs text-slate-400 mt-1">Shipping a multi-tenant education platform with dashboards and secure APIs.</p>
              </div>
            </div>
          </motion.div>
        </div>
